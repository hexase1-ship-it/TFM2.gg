...
- `overall`: AI 밴픽 보정용으로 스케일된 팀파매.gg 메타 점수입니다. 숫자가 높을수록 AI가 밴/픽에서 더 높게 평가합니다.
...
팀파매.gg는 대시보드의 raw 메타 스코어를 그대로 쓰지 않고, AI 훅 공식에 맞춘 별도 점수를 내보냅니다.

```text
OP/S: 약 80점대, 최대 +1.5 근처
1티어/A: 약 70점대, +1.0 근처
2티어/B: 약 60점대, +0.5 근처
3티어/C: 약 50점대, 중립
4티어/D: 약 40점대, -0.5 근처
...
이 값은 챔피언 표시 티어용 `champion_tier_policy.tsv`와 별도로 생성됩니다.
