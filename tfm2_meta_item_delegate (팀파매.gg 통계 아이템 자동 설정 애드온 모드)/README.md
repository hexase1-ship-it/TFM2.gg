...
- Version 0.2.6 is rebuilt with the Teamfight Manager 2 0.4.11 SDK.
...
Teamfight Manager 2 0.4.11 exposes no separate armor/defense item override enum, so dashboard `Defense` directions are mapped to `Hp`.
