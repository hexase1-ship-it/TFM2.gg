...
This repository keeps the source and current mod package files needed to maintain the TFM2.gg dashboard integration for Teamfight Manager 2 0.4.7.
...
- `native/tfm2_meta_item_delegate/` - Rust native mod source rebuilt for the 0.4.7 SDK.
