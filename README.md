...
This repository keeps the source and current package files needed to maintain the TFM2.gg dashboard integration for Teamfight Manager 2 0.4.11.
...
- `native/tfm2_meta_item_delegate/` - Rust native mod source rebuilt with the 0.4.11 SDK.
...
The native mods can be rebuilt against the current 0.4.11 SDK with:

```powershell
.\native\tfm2_meta_item_delegate\build_mod_0411.ps1 -SdkDir "C:\path\to\2_Mod SDK\mod-sdk"
.\native\tfm2_meta_champion_tiers\build_mod_0411.ps1 -SdkDir "C:\path\to\2_Mod SDK\mod-sdk"
.\native\tfm2_ai_banpick_probe\build_mod_0411.ps1 -SdkDir "C:\path\to\2_Mod SDK\mod-sdk"
```
